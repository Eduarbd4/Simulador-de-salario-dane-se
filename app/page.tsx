...
export default function Home(){
  ...
  const subCalc=useMemo(()=>{
    ...
    const salesBonusValues=salesBonus.map(v=>v?50:0),salesBonusTotal=eligible?(salesWeeks*50+salesBonusValues.reduce((a,b)=>a+b,0)):0;
    ...
    const g34=allSellers==="Todos!"?100:allSellers==="Exceto 1!"?50:0,g35=storeWeeks*75,subBonusValues=subBonus.map(v=>v?100:0),g40=checklist<80?0:150+2.5*(checklist-80);
    const subBonusTotal=g34+g35+subBonusValues.reduce((a,b)=>a+b,0)+g40;
